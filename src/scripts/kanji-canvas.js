(function (window, document) {
  ...
  KanjiCanvas.init = function (id) {
	...
	KanjiCanvas["canvas_" + id].dataset.strokeNumbers = 'false'; //disables stroke numbering
